...
- F5 refreshes only the highlighted playlist

## v1.144.0 - 2026-09-25

### Features

- Refresh a playlist from the Playlist Manager menu

## v1.143.1 - 2026-09-25

### Accessibility

- Make NVDA read player status and subtitle cues

## v1.143.0 - 2026-09-25

### Features

- Speak subtitles from loaded SRT and WebVTT files (#37)
...
- Translate backup errors, file filters and shortcut conflicts

### Other changes

- I18n(hu): review v1.142.1 additions and document subtitle speech audit (#36)
